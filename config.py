...
statistic = "Сейчас ботом пользуются {} человек"

repeated_marks = [
    [
        ["👁 Исследовать", "explore 2"],
        ["📜 Читать записку", "note 1"],
        ["⬆️ Вперед", "candle"],
        ["⬅️ Влево", "kitchen"],
        ["➡️ Вправо", "library"],
        ["↗️ Подняться по лестнице", "stairs on 2 floor"]
    ],
    [
        ["➡️ Обратно в холл", "hall 1"],
        ["🚰 Осмотреть раковину", "knife"],
        ["Осмотреть холодильник", "pitcher"]
    ],
    [
        ["🖼 Взглянуть на картину", "picture"],
        ["🛁 В ванную", "towel"],
